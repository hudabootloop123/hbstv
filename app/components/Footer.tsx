      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
              Platform streaming berbasis web terbaik. Tonton ribuan saluran TV langsung dari seluruh dunia tanpa perlu menginstal aplikasi apa pun. Mendukung streaming M3U, JSON, HLS, dan DASH.
            </p>
          </div>

          {/* TAUTAN CEPAT (Takes up 3 cols) */}
          <div className="md:col-span-3 flex flex-col gap-4">
            <h4 className="text-white font-bold tracking-wider uppercase text-xs">TAUTAN CEPAT</h4>
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            <h4 className="text-white font-bold tracking-wider uppercase text-xs">Bergabunglah dengan Komunitas</h4>
            <p className="text-zinc-400 text-sm mb-1">
              Hubungi kami untuk mendapatkan pembaruan, daftar putar khusus, dan dukungan.
            </p>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-zinc-500 font-medium">
            &copy; {new Date().getFullYear()} IPTV Player by <a href="https://github.com/hudabootloop123" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors font-bold">Huda Bootloop</a>. All rights reserved.
          </p>
          <div className="text-[10px] text-zinc-600 font-medium uppercase tracking-widest bg-white/5 px-2.5 py-1 rounded-md border border-white/5">
            Tidak berafiliasi dengan stasiun penyiaran mana pun.
          </div>
        </div>
      </div>
    </footer>
